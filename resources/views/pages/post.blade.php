    ...
    <article class="row format-standard">
        ...
        <div class="col-full s-content__main">
            ...
            <div class="s-content__author">
                <img src="{{ url('/images/user-03.jpg') }}" alt="">
    ...
    <div class="comments-wrap">
        ...
        <div id="comments" class="row">
            <div class="col-full">
                ...
                <?php if($post->comment->count() > 0){?><h3 class="h2"><?=($post->comment->count())==1?numSpan(1).' Comment':numSpan($post->comment->count()).' Comments';?></h3><?php }else {?>
                <h3 class="h2"> Comments Section</h3><?php }?>
